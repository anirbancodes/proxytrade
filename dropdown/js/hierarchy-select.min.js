  ...
  h.prototype = {
    ...
    moveDown: function () {
      ...
      void 0 !== e[n + 1] &&
        (this.$menuInner.find(".active").removeClass("active"),
        e[n + 1] &&
          (e[n + 1].classList.add("active"), s(this.$menuInner[0], e[n + 1])));
    },
    selectItem: function () {
      var e = this,
        t = this.$menuInner.find(".active");
        ...
        n &&
          setTimeout(function () {
            ...
            (t.scrollTop <= e.offsetTop - t.offsetTop &&
              t.scrollTop + t.clientHeight > e.offsetTop + e.clientHeight) ||
          ...
          switch (e.keyCode) {
            ...
            case 27:
              t.$element.hasClass("show") &&
                ...
                e.stopPropagation(),
                t.$button.focus(),
                t.previouslySelected && t.setSelected(t.previouslySelected),
                t.$button.dropdown("toggle"));
              break;
            case 38:
              t.$element.hasClass("show") &&
                (e.preventDefault(), e.stopPropagation(), t.moveUp());
              break;
            case 40:
              t.$element.hasClass("show") &&
                (e.preventDefault(), e.stopPropagation(), t.moveDown());
          }
        });
    },
                  ...
                  -1 !== e.text().toLowerCase().indexOf(t)
                    ? (e.toggleClass("disabled", !1),
                      ...
                      s.options.hierarchy &&
                        (function (e) {
                          for (
                            var t = e, n = t.data("level");
                            "object" == typeof t && 0 < t.length && 1 < n;

                          )
                            n--,
                              (t = t.prevAll(
                                'a[data-level="' + n + '"]:first'
                              )).hasClass("d-none") &&
